...
app.config.update(
    ...
    MAIL_DEFAULT_SENDER=(os.getenv("MAIL_DEFAULT_SENDER_NAME", "Health.io"), os.getenv("MAIL_USERNAME"))
)
...
try:
    db = mysql.connector.connect(
        ...
        database=os.getenv("DB_NAME", "healthio")
    )
    ...
    print("⚠️ Server will run but database operations will fail until MySQL is started")
